...
export const typescriptRoutes: Array<Route> = [
  {
    ...
    component: lazy(() => import(/* webpackChunkName: 'typescript-base' */ '@/pages/typescript/base')),
  },
  {
    name: '函数',
    path: '/typescript/function',
    component: lazy(() => import(/* webpackChunkName: 'typescript-function' */ '@/pages/typescript/function')),
  },
  {
    name: '泛型',
