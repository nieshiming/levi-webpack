...
export const hooksRoutes: Array<Route> = [
  ...
  },
  {
    ...
    component: lazy(() => import(/* webpackChunkName: 'hooks-useEffect' */ '@/pages/hooks/useEffect')),
  },
  {
    name: 'useContext',
    path: '/hooks/useContext',
    component: lazy(() => import(/* webpackChunkName: 'hooks-useContext' */ '@/pages/hooks/useContext')),
  },
  {
    name: 'useCallback',
    path: '/hooks/useCallback',
    component: lazy(() => import(/* webpackChunkName: 'hooks-useCallback' */ '@/pages/hooks/useCallback')),
  },
  {
    name: 'useRef',
    path: '/hooks/useRef',
  ...
  },
  {
    ...
    component: lazy(() => import(/* webpackChunkName: 'hooks-customize' */ '@/pages/hooks/customize')),
  },
]
